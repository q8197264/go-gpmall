...
class AddressStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.QueryAddressList = channel.unary_unary(
                '/Address/QueryAddressList',
...
class AddressServicer(object):
    ...
    def QueryAddressList(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_AddressServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'QueryAddressList': grpc.unary_unary_rpc_method_handler(
                    servicer.QueryAddressList,
...
class Address(object):
    ...
    def QueryAddressList(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Address/QueryAddressList',
    ...
    def AddAddress(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Address/AddAddress',
            address__pb2.AddressRequest.SerializeToString,
